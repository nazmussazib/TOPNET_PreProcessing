...
#define TURN_OFF_OPTIMIZATIONS

#ifdef TURN_OFF_OPTIMIZATIONS
#pragma optimize( "", off )
#endif
...
int reconstruct(
				/* trianglelist, triangleattriblist, trianglearealist, elements,
...
enum circumcenterresult findcircumcenter(point torg, point tdest, point tapex, point circumcenter,
                                         REAL *xi, REAL *eta)
/*point torg;
point tdest;
point tapex;
...
void transfernodes(REAL *pointlist, REAL *pointattriblist, int *pointmarkerlist, int numberofpoints,
...
#ifdef TURN_OFF_OPTIMIZATIONS
#pragma optimize( "", on ) //end of file, turn optimizations back on
#endif